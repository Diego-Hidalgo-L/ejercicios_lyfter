...
def print_10_or_less_elements(list_to_print):
	...
	for index in range(min(list_len, 10)): # O(1), porque siempre va a iterar un máximo de 10 veces.
		print(list_to_print[index]) # O(1)


my_list = [311, 22, 53, 1241, 12334, 123, 354, 6, 666, 78, 89, 100, 321]

print_10_or_less_elements(my_list)

# print(min(len(my_list)))
